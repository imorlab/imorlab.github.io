<template>
  <section class="min-h-[calc(100vh-4rem)] py-16">
    <!-- Back Button -->
      ...
      <div class="border-t border-gray-700/30 pt-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <router-link
            ...
            :to="localePath(`/projects/${relatedProject.id}`)"
...
// Metadatos propios de cada proyecto (canonical/hreflang sobre /projects/:id).
usePageMeta(
  'projects',
  () => `/projects/${projectId.value}`,
  {
    title: computed(() =>
      project.value ? `${project.value.title} – ${project.value.company} · Israel Moreno` : t('meta.projects.title')
    ),
    description: computed(() => project.value?.description || t('meta.projects.description'))
  }
);

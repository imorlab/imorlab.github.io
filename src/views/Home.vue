<template>
  <div class="min-h-screen bg-primary relative overflow-hidden">
    ...
    <!-- Hero Section -->
    <div class="min-h-[90vh] flex items-center justify-center relative px-4 sm:px-6 lg:px-8">
          ...
          <div class="z-10">
            ...
            <div class="flex flex-wrap gap-4">
              ...
              <router-link to="/contact" 
                class="nav-link border border-accent px-6 py-2 rounded-md hover:bg-accent/10 transition-colors duration-300">
                Contactar
              </router-link>
            </div>
            ...
            <div class="mt-12">
              <div class="flex items-center gap-6">
                ...
                <a href="https://linkedin.com/in/imorlab" target="_blank" rel="noopener noreferrer"
                  class="text-gray-400 hover:text-accent transition-colors">
                  <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                  </svg>
                </a>
                <a href="https://twitter.com/imorlab" target="_blank" rel="noopener noreferrer"
                  class="text-gray-400 hover:text-accent transition-colors">
                  <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div class="flex justify-center z-10">
            <div class="relative group">
              ...
              <div class="w-64 h-64 sm:w-80 sm:h-80 rounded-full overflow-hidden 
                          bg-gradient-to-br from-accent/20 to-accent/5 backdrop-blur-sm
              ...
              <div class="absolute inset-0 rounded-full border-2 border-accent/20
                          group-hover:border-accent/40 group-hover:scale-105
